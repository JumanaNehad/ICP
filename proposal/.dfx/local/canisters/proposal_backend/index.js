...
import { idlFactory } from './proposal_backend.did.js';
export { idlFactory } from './proposal_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROPOSAL_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proposal_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proposal_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proposal_backend.did.js")._SERVICE>}
 */
export const proposal_backend = createActor(canisterId);
