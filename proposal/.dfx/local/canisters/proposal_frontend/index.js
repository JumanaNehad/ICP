...
import { idlFactory } from './proposal_frontend.did.js';
export { idlFactory } from './proposal_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROPOSAL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proposal_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proposal_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proposal_frontend.did.js")._SERVICE>}
 */
export const proposal_frontend = createActor(canisterId);
