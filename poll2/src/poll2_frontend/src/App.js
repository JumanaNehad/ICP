import { poll2_backend } from "../../declarations/poll2_backend";
...
document.addEventListener(
  ...
  async (e) => {
    ...
    const question = await poll2_backend.get_question();
    ...
    const voteCounts = await poll2_backend.get_votes();
...
pollForm.addEventListener(
  ...
  async (e) => {
    ...
    const updatedVoteCounts = await poll2_backend.vote(checkedValue);
...
resetButton.addEventListener(
  ...
  async (e) => {
    ...
    await poll2_backend.reset_votes();
    const voteCounts = await poll2_backend.get_votes();
    updateLocalVoteCounts(JSON.parse(voteCounts));
