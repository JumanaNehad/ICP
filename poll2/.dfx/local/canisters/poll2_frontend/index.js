...
import { idlFactory } from './poll2_frontend.did.js';
export { idlFactory } from './poll2_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_POLL2_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./poll2_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the poll2_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./poll2_frontend.did.js")._SERVICE>}
 */
export const poll2_frontend = createActor(canisterId);
