...
import { idlFactory } from './exam2_backend.did.js';
export { idlFactory } from './exam2_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EXAM2_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./exam2_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the exam2_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./exam2_backend.did.js")._SERVICE>}
 */
export const exam2_backend = createActor(canisterId);
