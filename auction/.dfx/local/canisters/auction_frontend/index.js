...
import { idlFactory } from './auction_frontend.did.js';
export { idlFactory } from './auction_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUCTION_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auction_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auction_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auction_frontend.did.js")._SERVICE>}
 */
export const auction_frontend = createActor(canisterId);
