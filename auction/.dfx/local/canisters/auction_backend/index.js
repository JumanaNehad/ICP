...
import { idlFactory } from './auction_backend.did.js';
export { idlFactory } from './auction_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUCTION_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auction_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auction_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auction_backend.did.js")._SERVICE>}
 */
export const auction_backend = createActor(canisterId);
